...
const AddStudentPage = () => {
  ...
  const [isDarkMode, setIsDarkMode] = useState(false) // Assuming theme state might be passed or managed globally
  ...
  const handleSubmit = (e) => {
    ...
    alert("Student added successfully! (This is a demo action)")
    ...
    <>
      ...
      >
        <motion.div
          ...
          } rounded-xl p-8 sm:p-10 w-full max-w-lg text-center animate-form`}
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            <div>
              <label
                htmlFor="name"
                className={`block text-sm font-medium ${isDarkMode ? "dark-text-secondary" : "text-gray-700"} mb-1`}
              >
                Student Name
              </label>
              <input
