  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success === false) {
        ...
        // Navigate to verify email page, optionally pass email as state
      ...
      <div className="bg-white p-10 rounded-3xl shadow-2xl border w-full max-w-md">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border pl-10 pr-4 py-2 rounded-xl bg-[#f9fafb]"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2">{DeptIcon}</span>
              <input
                type="text"
                name="department"
