                      ...
                      <div className="space-y-6">
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            className="w-full h-12 pl-12 pr-16 bg-gray-800/60 border border-gray-600/50 rounded-xl text-white text-xs placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 backdrop-blur-sm font-medium"
                            placeholder="••••••••"
                          />
                          <div className="absolute inset-y-0 right-0 flex items-center pr-4">
                            <button
                              ...
                              className="text-gray-400 hover:text-blue-400 transition-colors focus:outline-none p-1 h-8 w-8 flex items-center justify-center"
